...
try {
  ...
  await test('city menu lists all eight cities; CHI loads (empty until first crawl)', async () => {
    ...
    assert.deepEqual(options.map((s) => s.trim()), ['NYC', 'LA', 'CHICAGO', 'SF', 'PARIS', 'LONDON', 'BOSTON', 'TOKYO']);
